...
void GuiScreen::ScreenInit()
{
	...
	// howtoplay screen page1
	// background panel
	AddToPage(rect, ScreenPage::About1);
	...
	// howtoplay screen page2
	AddToPage(rect, ScreenPage::About2);
